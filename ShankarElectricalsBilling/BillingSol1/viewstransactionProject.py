        ...
        if 'cmdGetSite' in request.POST:  
            ...
            if 'cmbSite' in request.POST: 
                if(data.get('cmbSite').isnumeric()):
                    ...
                    if MsitelistGet:
                        customernamesite = MsitelistGet.slocation  + " "  + MsitelistGet.splace # MsitelistGet.slocation  + " "  + MsitelistGet.splace # MsitelistGet.splace  # MsitelistGet.slocation  + " "  + MsitelistGet.splace 
