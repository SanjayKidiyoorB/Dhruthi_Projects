            ...
            if (ClassificationData == 0):
                ...
                if (ID_Categories == 0):
                    ...
                    if (bFlag == 0):
                        ...
                        MasterinstrumentslistSave = Masterinstrumentslist(sinstrumentid  = sinstrumentid,  lrepairid =  0, bunderrepair =  0, lvalibationid =  0, bundervalidation =  0, l8did =  0, bunder8d =  0, lmsarnrid =  0, bunderrnr =  0, bunderattribute =  0, lstabilityid =  0, bunderstability =  0, lbiasid = 0,  bunderbias = 0, llinearityid = 0, bunderlinearity = 0 )
