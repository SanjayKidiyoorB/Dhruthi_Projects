...
def GaugeCalendarList(request):
    ...
    if request.method == "POST":
        ...
        return render(request,  'CloudCaliber/GaugeMasterlistDueCalendar.html', 
        {
            'title':'User list', 
...
@csrf_exempt
def GMlistClassificationCalendarCreate_ID(request):
...
@csrf_exempt
def load_GMlistClassificationCalendarCreate_ID(request):
...
@csrf_exempt
def load_GMlisCategoryCalendarCreate_ID(request):
...
@csrf_exempt
def load_GMlisFlow1CalendarCreate_ID(request):
...
@csrf_exempt
def load_GMlisFlow2CalendarCreate_ID(request):
...
@csrf_exempt
def load_GMlisFlow3CalendarCreate_ID(request):
...
@csrf_exempt
def load_GMlisFlow4CalendarCreate_ID(request):
...
@csrf_exempt
def load_GMlisFlow5CalendarCreate_ID(request):
...
@csrf_exempt
def load_GMlisFlow6CalendarCreate_ID(request):
