...
from CloudCaliber.models import Thistorymain, Thistorymainpart1, Thistorymainpart2, Masterinstrumentslist , Masterinstrumentslistpart2,   Masterinstrumentpreventivemabigintenancelist 
...
def GaugeIssue(request, lID):
    ...
    if request.method == "POST":
        ...
        if 'cmbSearch' in request.POST: 

     
            if( rad_Priority == "Line / Location Issue"):


                request.session['rad_Priority']   =  "Line / Location Issue"
                ...
                return render(request, "CloudCaliber/GaugeIssueDetails.html", 
                {
                    ...
                    'sCodeFinal1': "" ,  
                    'sCodeFinal2': "" ,  
                    'rad_Priority': "Line / Location Issue",
                    'cmbClassificationID': 0 , 
                    'cmbCategoryID': 0 ,  
                    'cmbFlow1ID': 0 ,  
                    'cmbFlow2ID': 0 ,  
            ...
            if( rad_Priority == "Supplier Issue"):
                request.session['rad_Priority']   =  "Supplier Issue"
                AdminunitlistActive = Adminunitlist.objects.get(lplantid=lPlantId) 
                if AdminunitlistActive:
                    sPlantCode = AdminunitlistActive.splantno
                    sPlantNameName = AdminunitlistActive.splantname + " (" + AdminunitlistActive.scode.strip() + ")"
                ...
                Adminassettypelist_list =  Adminassetcategorytypelist.objects.order_by('scategorytype')
                lunitidA=request.session['lunitid']  
                AreaofUselist_list = Adminexternalagencylist.objects.filter(bmeasurement=1).order_by('sdescription').values()     
            ...
            if( rad_Priority == "Transfer to other plant"):
                request.session['rad_Priority']   =  "Transfer to other plant"
                AdminunitlistActive = Adminunitlist.objects.get(lplantid=lPlantId) 
                if AdminunitlistActive:
                    sPlantCode = AdminunitlistActive.splantno
                    sPlantNameName = AdminunitlistActive.splantname + " (" + AdminunitlistActive.scode.strip() + ")"
                ...
                Adminassettypelist_list =  Adminassetcategorytypelist.objects.order_by('scategorytype')
                lunitidA=request.session['lunitid']  
                AreaofUselist_list = Adminunitlist.objects.order_by('splantno')      
                ...
                return render(request, "CloudCaliber/GaugeIssueDetails.html", 
                {
                    ...
                    'title':'User list', 
                    'message':'Your User list page.',
                    'rad_Priority': "Transfer to other plant",
                    'sPlantName': sPlantName , 
                    'Location': 0 , 
                    'semployeename':  semployeename,
                    'txtSearch': "" , 
        ...
        if 'cmbIssued' in request.POST: 
            ...
            #rad_Priority = request.session['rad_Priority']  
            cmbLocationNew = 0
            if 'cmbLocationNew' in request.POST:
                cmbLocationNew = int(data.get("cmbLocationNew"))

            if (cmbLocationNew == 0):
                messages.success(request, 'Location is not selected. Please select Issue Line / Location and Save')
                ...
                return render(request, "CloudCaliber/GaugeIssueDetails.html", 
                {
                    ...
                    'bSAPCodeNotDone': bSAPCodeNotDone,  
                    'sIssueDate': sIssueDate, 
                    'rad_Priority': rad_Priority,
                }) 
            
            if (txtIssuedTo == ""):
                messages.success(request, 'Issued To Employee is not Entered. Please enter Employee Name / ID to be Issued and Save')
            ...
            if (txtMachineTo == ""):
                messages.success(request, 'Issued To Machine is not Entered. Please enter Machine Name / ID to be Issued and Save')
            ...
            elif(rad_Priority == "Supplier Issue"):
                AreaofUselist_listAQ =  Adminexternalagencylist.objects.get(  lagencyid=llineid)
                if AreaofUselist_listAQ:  
                    slinename =  AreaofUselist_listAQ.sdescription
                    sto = "Issued To Supplier : " + slinename + " Received by : "+ txtIssuedTo + "  Machine Ref : " + txtMachineTo + "  Part Ref : " + txtPartNo
  
            elif(rad_Priority == "Transfer to other plant"):
                AreaofUselist_listAQ =  Adminunitlist.objects.get(  lplantid=llineid)
                if AreaofUselist_listAQ:  
                    slinename =  AreaofUselist_listAQ.splantno + " | " + AreaofUselist_listAQ.splantname
                    sto = "Transferred To : " + slinename + " Received by : "+ txtIssuedTo + "  Machine Ref : " + txtMachineTo + "  Part Ref : " + txtPartNo
            ...
            if(rad_Priority == "Supplier Issue"):
                MasterinstrumentslistSaveOBJA.bissedtosupplier = 1

            if(rad_Priority == "Transfer to other plant"):
                MasterinstrumentslistSaveOBJA.scurrentstatus ="TRANSFERRED" 
...
def GaugeReturn(request, lID):
    ...
    if request.method == "POST":
        ...
        if 'cmbReceived' in request.POST: 
            ...
            if (cmbReturnStatus == 0):
                messages.success(request, 'Status is not selected. Please select Gauge / Instrument return status / condition and Save')
            ...
            MasterinstrumentslistSaveOBJA.bissedtosupplier = 0
            MasterinstrumentslistSaveOBJA.save()
...
def GaugePrepone(request, lID):
    ...
    if request.method == "POST":
        ...
        txtPreponeDate3 = ""
        txtPreponeDate = ""
        if 'txtPreponeDate' in request.POST:
            txtPreponeDate = data.get("txtPreponeDate")

            txtPreponeDate1 = txtPreponeDate
            txtPreponeDate2  = txtPreponeDate1.split("/")
            txtPreponeDate = ""
            
            if(len(txtPreponeDate2) > 1):
                txtPreponeDate = txtPreponeDate2[2] + "-" + txtPreponeDate2[1] + "-" + txtPreponeDate2[0]
            else:
                txtPreponeDate2  = txtPreponeDate1.split("-") 
                if(len(txtPreponeDate2) > 1):
                    txtPreponeDate = txtPreponeDate2[2] + "-" + txtPreponeDate2[1] + "-" + txtPreponeDate2[0] 
        ...
        if(txtPreponeDate == ''): 
            txtPreponeDate =str(datetime.now()) 
            txtPreponeDate = txtPreponeDate[0:10] 
        ...
        txtPreponedBy = ""
        if 'txtPreponedBy' in request.POST:
            txtPreponedBy = data.get("txtPreponedBy")
        ...
        if 'cmbPrepone' in request.POST: 
        

            if (txtReason == 0):
                messages.success(request, 'Reason for Prepone is not entered. Please enter Reason and Save')
                ...
                return render(request, "CloudCaliber/GaugePrepone.html", 
                {
                    'Masterinstrumentslist_listA':Masterinstrumentslist_list, 
            ...
            if (txtApproved == ""):
                messages.success(request, 'Prepone Approval is not Entered. Please enter Approval Employee Name / ID  and Save')
            ...
            scurrentstatus=""
            scurrentstatus="Prepone"
            dtcalibrationdate=datetime.now()
            dtcalibrationdate=datetime.strptime(txtPreponeDate, '%d-%m-%Y').date()
            fcalibcost=0
            llplantid=0
            ssplantname=""
            slplantcode=""
            ...
            scomment="Calibration Prepone from " + str(MasterinstrumentslistSaveOBJA.snextcalibdate) + " to " + str(txtPreponeDate) + " | by : " + senteredby + " | Approvedby : " + txtApproved + " | Reason : " + txtReason
            MasterinstrumentslistSaveOBJA.dtnextcalib =dtcalibrationdate
            MasterinstrumentslistSaveOBJA.snextcalibdate =txtPreponeDate
...
def GaugePostpone(request, lID):
    ...
    if request.method == "POST":
        ...
        txtPostponeDate3 = ""
        txtPostponeDate = ""
        if 'txtPostponeDate' in request.POST:
            txtPostponeDate = data.get("txtPostponeDate")

            txtPostponeDate1 = txtPostponeDate
            txtPostponeDate2  = txtPostponeDate1.split("/")
            txtPostponeDate = ""
            
            if(len(txtPostponeDate2) > 1):
                txtPostponeDate = txtPostponeDate2[2] + "-" + txtPostponeDate2[1] + "-" + txtPostponeDate2[0]
            else:
                txtPostponeDate2  = txtPostponeDate1.split("-") 
                if(len(txtPostponeDate2) > 1):
                    txtPostponeDate = txtPostponeDate2[2] + "-" + txtPostponeDate2[1] + "-" + txtPostponeDate2[0] 
        ...
        if(txtPostponeDate == ''): 
            txtPostponeDate =str(datetime.now()) 
            txtPostponeDate = txtPostponeDate[0:10] 
        ...
        txtPostponedBy = ""
        if 'txtPostponedBy' in request.POST:
            txtPostponedBy = data.get("txtPostponedBy")
        ...
        if 'cmbPostpone' in request.POST: 

            if (txtReason == 0):
                messages.success(request, 'Reason for Postpone is not entered. Please enter Reason and Save')
                ...
                return render(request, "CloudCaliber/GaugePostpone.html", 
                {
                    'Masterinstrumentslist_listA':Masterinstrumentslist_list, 
            ...
            if (txtApproved == ""):
                messages.success(request, 'Postpone Approval is not Entered. Please enter Approval Employee Name / ID  and Save')
            ...
            scurrentstatus=""
            scurrentstatus="Postpone"
            dtcalibrationdate=datetime.now()
            dtcalibrationdate=datetime.strptime(txtPostponeDate, '%d-%m-%Y').date()
            fcalibcost=0
            llplantid=0
            ssplantname=""
            slplantcode=""
            ...
            scomment="Calibration Postpone from " + str(MasterinstrumentslistSaveOBJA.snextcalibdate) + " to " + str(txtPostponeDate) + " | by : " + senteredby + " | Approvedby : " + txtApproved + " | Reason : " + txtReason
            MasterinstrumentslistSaveOBJA.dtnextcalib =dtcalibrationdate
            MasterinstrumentslistSaveOBJA.snextcalibdate =txtPostponeDate
...
@csrf_exempt
def GaugeMissingScrap(request, lID):
    ...
    if request.method == "POST":
        ...
        if 'cmbMissingScrap' in request.POST: 
            ...
            if (txtReason == 0):
                ...
                return render(request, "CloudCaliber/GaugeMissingScrap.html", 
                {
                    'Masterinstrumentslist_listA':Masterinstrumentslist_list, 
            ...
            scomment="Gauge Missing - Scrapped on " + str(txtMissingScrapDate) + " | by : " + senteredby + " | Approvedby : " + txtApproved + " | Reason : " + txtReason
            MasterinstrumentslistSaveOBJA.scurrentstatus ="SCRAPPED" 
...
@csrf_exempt
def GaugeMissingRecover(request, lID):
    ...
    if request.method == "POST":
        ...
        if 'cmbMissingScrap' in request.POST: 
            ...
            if (txtReason == 0):
                ...
                return render(request, "CloudCaliber/GaugeMissingRecover.html", 
                {
                    'Masterinstrumentslist_listA':Masterinstrumentslist_list, 
            ...
            scomment="Gauge Missing - Recovered on " + str(txtMissingScrapDate) + " | by : " + senteredby + " | Approvedby : " + txtApproved + " | Reason : " + txtReason
