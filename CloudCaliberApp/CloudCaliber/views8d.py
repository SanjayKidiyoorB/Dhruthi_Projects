...
@csrf_exempt
def GMlistClassification8DCreate_ID(request):
...
@csrf_exempt
def load_GMlistClassification8DCreate_ID(request):
...
@csrf_exempt
def load_GMlisCategory8DCreate_ID(request):
...
@csrf_exempt
def load_GMlisFlow18DCreate_ID(request):
...
@csrf_exempt
def load_GMlisFlow28DCreate_ID(request):
...
@csrf_exempt
def load_GMlisFlow38DCreate_ID(request):
...
@csrf_exempt
def load_GMlisFlow48DCreate_ID(request):
...
@csrf_exempt
def load_GMlisFlow58DCreate_ID(request):
...
@csrf_exempt
def load_GMlisFlow68DCreate_ID(request):
