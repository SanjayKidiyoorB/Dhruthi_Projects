...
class Masterinstrumentslist(models.Model):
    ...
    bunderrepair = models.IntegerField(db_column='bUnderRepair', blank=True, null=True)  # Field name made lowercase.
    lvalibationid = models.IntegerField(db_column='lValibationID', blank=True, null=True)  # Field name made lowercase.
    bundervalidation = models.IntegerField(db_column='bUnderValidation', blank=True, null=True)  # Field name made lowercase.
    l8did = models.IntegerField(db_column='l8DID', blank=True, null=True)  # Field name made lowercase.
    bunder8d = models.IntegerField(db_column='bUnder8D', blank=True, null=True)  # Field name made lowercase.
    lmsarnrid = models.IntegerField(db_column='lMSARnRID', blank=True, null=True)  # Field name made lowercase.
    bunderrnr = models.IntegerField(db_column='bUnderRnR', blank=True, null=True)  # Field name made lowercase.
    bunderattribute = models.IntegerField(db_column='bUnderAttribute', blank=True, null=True)  # Field name made lowercase.
    lstabilityid = models.IntegerField(db_column='lStabilityID', blank=True, null=True)  # Field name made lowercase.
    bunderstability = models.IntegerField(db_column='bUnderStability', blank=True, null=True)  # Field name made lowercase.
    lbiasid = models.IntegerField(db_column='lBiasID', blank=True, null=True)  # Field name made lowercase.
    bunderbias = models.IntegerField(db_column='bUnderBias', blank=True, null=True)  # Field name made lowercase.
    llinearityid = models.IntegerField(db_column='lLinearityID', blank=True, null=True)  # Field name made lowercase.
    bunderlinearity = models.IntegerField(db_column='bUnderLinearity', blank=True, null=True)  # Field name made lowercase.
    btransferred = models.IntegerField(db_column='bTransferred', blank=True, null=True)  # Field name made lowercase.
    bissedtosupplier = models.IntegerField(db_column='bIssedtoSupplier', blank=True, null=True)  # Field name made lowercase.
...
class Masterinstrumentslistb(models.Model):
    lid = models.CharField(db_column='lID', max_length=50, blank=True, null=True)  # Field name made lowercase.
    sinstrumentid = models.CharField(db_column='sInstrumentId', max_length=50, blank=True, null=True)  # Field name made lowercase.
    sdescription = models.CharField(db_column='sDescription', max_length=50, blank=True, null=True)  # Field name made lowercase.
    sassettype = models.CharField(db_column='sAssetType', max_length=50, blank=True, null=True)  # Field name made lowercase.
    lplantid = models.CharField(db_column='lPlantID', max_length=50, blank=True, null=True)  # Field name made lowercase.
    splanttype = models.CharField(db_column='sPlantType', max_length=50, blank=True, null=True)  # Field name made lowercase.
    lcategoryid = models.CharField(db_column='lCategoryID', max_length=50, blank=True, null=True)  # Field name made lowercase.
    ...
    lassetid = models.CharField(db_column='lAssetID', max_length=50, blank=True, null=True)  # Field name made lowercase.
    btyperef1 = models.CharField(db_column='bTypeRef1', max_length=50, blank=True, null=True)  # Field name made lowercase.
    scategorytype1 = models.CharField(db_column='sCategoryType1', max_length=50, blank=True, null=True)  # Field name made lowercase.
    styperefname1 = models.CharField(db_column='sTypeRefName1', max_length=50, blank=True, null=True)  # Field name made lowercase.
    btyperef2 = models.CharField(db_column='bTypeRef2', max_length=50, blank=True, null=True)  # Field name made lowercase.
    scategorytype2 = models.CharField(db_column='sCategoryType2', max_length=50, blank=True, null=True)  # Field name made lowercase.
    styperefname2 = models.CharField(db_column='sTypeRefName2', max_length=50, blank=True, null=True)  # Field name made lowercase.
    btyperef3 = models.CharField(db_column='bTypeRef3', max_length=50, blank=True, null=True)  # Field name made lowercase.
    scategorytype3 = models.CharField(db_column='sCategoryType3', max_length=50, blank=True, null=True)  # Field name made lowercase.
    styperefname3 = models.CharField(db_column='sTypeRefName3', max_length=50, blank=True, null=True)  # Field name made lowercase.
    btyperef4 = models.CharField(db_column='bTypeRef4', max_length=50, blank=True, null=True)  # Field name made lowercase.
    scategorytype4 = models.CharField(db_column='sCategoryType4', max_length=50, blank=True, null=True)  # Field name made lowercase.
    styperefname4 = models.CharField(db_column='sTypeRefName4', max_length=50, blank=True, null=True)  # Field name made lowercase.
    btyperef5 = models.CharField(db_column='bTypeRef5', max_length=50, blank=True, null=True)  # Field name made lowercase.
    scategorytype5 = models.CharField(db_column='sCategoryType5', max_length=50, blank=True, null=True)  # Field name made lowercase.
    styperefname5 = models.CharField(db_column='sTypeRefName5', max_length=50, blank=True, null=True)  # Field name made lowercase.
    smake = models.CharField(db_column='sMake', max_length=50, blank=True, null=True)  # Field name made lowercase.
    ldefaultlocationid = models.CharField(db_column='lDefaultLocationId', max_length=50, blank=True, null=True)  # Field name made lowercase.
    slocationname = models.CharField(db_column='sLocationName', max_length=50, blank=True, null=True)  # Field name made lowercase.
    scurrentstatus = models.CharField(db_column='sCurrentstatus', max_length=50, blank=True, null=True)  # Field name made lowercase.
    bcalib = models.CharField(db_column='bCalib', max_length=50, blank=True, null=True)  # Field name made lowercase.
    dtlastcalib = models.CharField(db_column='dtLastCalib', max_length=50, blank=True, null=True)  # Field name made lowercase.
    dtnextcalib = models.CharField(db_column='dtNextCalib', max_length=50, blank=True, null=True)  # Field name made lowercase.
    slastcalibdate = models.CharField(db_column='sLastCalibDate', max_length=50, blank=True, null=True)  # Field name made lowercase.
    snextcalibdate = models.CharField(db_column='sNextCalibDate', max_length=50, blank=True, null=True)  # Field name made lowercase.
    dtcalibdisplaydate = models.CharField(db_column='dtCalibDisplayDate', max_length=50, blank=True, null=True)  # Field name made lowercase.
    ldueday = models.CharField(db_column='lDueDay', max_length=50, blank=True, null=True)  # Field name made lowercase.
    lduemonth = models.CharField(db_column='lDueMonth', max_length=50, blank=True, null=True)  # Field name made lowercase.
    ldueyear = models.CharField(db_column='lDueYear', max_length=50, blank=True, null=True)  # Field name made lowercase.
    sfreqtype = models.CharField(db_column='sFreqType', max_length=50, blank=True, null=True)  # Field name made lowercase.
    busagewise = models.CharField(db_column='bUsageWise', max_length=50, blank=True, null=True)  # Field name made lowercase.
    lcalibrationvendorid = models.CharField(db_column='lCalibrationVendorID', max_length=50, blank=True, null=True)  # Field name made lowercase.
    scalibvendor = models.CharField(db_column='sCalibVendor', max_length=50, blank=True, null=True)  # Field name made lowercase.
    bcheckin = models.CharField(db_column='bCheckin', max_length=50, blank=True, null=True)  # Field name made lowercase.
    busage = models.CharField(db_column='bUsage', max_length=50, blank=True, null=True)  # Field name made lowercase.
    blimitedusage = models.CharField(db_column='bLimitedUsage', max_length=50, blank=True, null=True)  # Field name made lowercase.
    bdamaged = models.CharField(db_column='bDamaged', max_length=50, blank=True, null=True)  # Field name made lowercase.
    battribute = models.CharField(db_column='bAttribute', max_length=50, blank=True, null=True)  # Field name made lowercase.
    bfreezecalib = models.CharField(db_column='bFreezeCalib', max_length=50, blank=True, null=True)  # Field name made lowercase.
    bvalidation = models.CharField(db_column='bValidation', max_length=50, blank=True, null=True)  # Field name made lowercase.
    bsentforcalibration = models.CharField(db_column='bSentForCalibration', max_length=50, blank=True, null=True)  # Field name made lowercase.
    oldinstrument_id = models.CharField(db_column='OLDInstrument_Id', max_length=50, blank=True, null=True)  # Field name made lowercase.
    sinstrumentcode = models.CharField(db_column='sInstrumentCode', max_length=50, blank=True, null=True)  # Field name made lowercase.
    bpurchaseclosed = models.CharField(db_column='bPurchaseClosed', max_length=50, blank=True, null=True)  # Field name made lowercase.
    bidlecalibration = models.CharField(db_column='bIdleCalibration', max_length=50, blank=True, null=True)  # Field name made lowercase.
    bsamplepartusage = models.CharField(db_column='bSamplePartusage', max_length=50, blank=True, null=True)  # Field name made lowercase.
    bregularpartusage = models.CharField(db_column='bRegularPartUsage', max_length=50, blank=True, null=True)  # Field name made lowercase.
    bcalibstandards = models.CharField(db_column='bCalibStandards', max_length=50, blank=True, null=True)  # Field name made lowercase.
    spartno = models.CharField(db_column='sPartNo', max_length=50, blank=True, null=True)  # Field name made lowercase.
    lcompanyid = models.CharField(db_column='lCompanyId', max_length=50, blank=True, null=True)  # Field name made lowercase.
    bplanned = models.CharField(db_column='bPlanned', max_length=50, blank=True, null=True)  # Field name made lowercase.
    serpcode = models.CharField(db_column='sERPCode', max_length=50, blank=True, null=True)  # Field name made lowercase.
    lhistorycard = models.CharField(db_column='lHistoryCard', max_length=50, blank=True, null=True)  # Field name made lowercase.
    lfolowid1 = models.CharField(db_column='lFolowID1', max_length=50, blank=True, null=True)  # Field name made lowercase.
    lfolowid2 = models.CharField(db_column='lFolowID2', max_length=50, blank=True, null=True)  # Field name made lowercase.
    lfolowid3 = models.CharField(db_column='lFolowID3', max_length=50, blank=True, null=True)  # Field name made lowercase.
    lfolowid4 = models.CharField(db_column='lFolowID4', max_length=50, blank=True, null=True)  # Field name made lowercase.
    lfolowid5 = models.CharField(db_column='lFolowID5', max_length=50, blank=True, null=True)  # Field name made lowercase.
    ltolid = models.CharField(db_column='lTolID', max_length=50, blank=True, null=True)  # Field name made lowercase.
    sissueddate = models.CharField(db_column='sIssuedDate', max_length=50, blank=True, null=True)  # Field name made lowercase.
    sreturneddate = models.CharField(db_column='sReturnedDate', max_length=50, blank=True, null=True)  # Field name made lowercase.
    bsapcodegenerate = models.CharField(db_column='bSAPCodeGenerate', max_length=50, blank=True, null=True)  # Field name made lowercase.
    bcalibrateidle = models.CharField(db_column='bCalibrateIdle', max_length=50, blank=True, null=True)  # Field name made lowercase.
    scalibrationstartdate = models.CharField(db_column='sCalibrationStartDate', max_length=50, blank=True, null=True)  # Field name made lowercase.
    smsastartdate = models.CharField(db_column='sMSAStartDate', max_length=50, blank=True, null=True)  # Field name made lowercase.
    svalidationstartdate = models.CharField(db_column='sValidationStartDate', max_length=50, blank=True, null=True)  # Field name made lowercase.
    bshowlistascalibrate = models.CharField(db_column='bShowListasCalibrate', max_length=50, blank=True, null=True)  # Field name made lowercase.
    sdamagedon = models.CharField(db_column='sDamagedON', max_length=50, blank=True, null=True)  # Field name made lowercase.
    smissingon = models.CharField(db_column='sMissingON', max_length=50, blank=True, null=True)  # Field name made lowercase.
    sinitiatedon = models.CharField(db_column='sInitiatedOn', max_length=50, blank=True, null=True)  # Field name made lowercase.
    spurchaseon = models.CharField(db_column='sPurchaseOn', max_length=50, blank=True, null=True)  # Field name made lowercase.
    breferencegauge = models.CharField(db_column='bReferenceGauge', max_length=50, blank=True, null=True)  # Field name made lowercase.
    slimitedcomment = models.CharField(db_column='sLimitedComment', max_length=50, blank=True, null=True)  # Field name made lowercase.
    ssize = models.CharField(db_column='sSize', max_length=50, blank=True, null=True)  # Field name made lowercase.
    size = models.CharField(max_length=50, blank=True, null=True)
    ssizea = models.CharField(db_column='sSizeA', max_length=50, blank=True, null=True)  # Field name made lowercase.
    sissuedto = models.CharField(db_column='sIssuedTo', max_length=50, blank=True, null=True)  # Field name made lowercase.
    sissuedmachineto = models.CharField(db_column='sIssuedMachineTo', max_length=50, blank=True, null=True)  # Field name made lowercase.
    sissuedpartno = models.CharField(db_column='sIssuedPartNo', max_length=50, blank=True, null=True)  # Field name made lowercase.
    straceability = models.CharField(db_column='sTraceability', max_length=50, blank=True, null=True)  # Field name made lowercase.
    scertificateno = models.CharField(db_column='sCertificateNo', max_length=50, blank=True, null=True)  # Field name made lowercase.
    scalibcertificatfile = models.CharField(db_column='sCalibCertificatFile', max_length=50, blank=True, null=True)  # Field name made lowercase.
    lhistoryid = models.CharField(db_column='lHistoryID', max_length=50, blank=True, null=True)  # Field name made lowercase.
    sstoragelocation = models.CharField(db_column='sStorageLocation', max_length=50, blank=True, null=True)  # Field name made lowercase.
    lrepairid = models.CharField(db_column='lRepairID', max_length=50, blank=True, null=True)  # Field name made lowercase.
    bunderrepair = models.CharField(db_column='bUnderRepair', max_length=50, blank=True, null=True)  # Field name made lowercase.
    lvalibationid = models.CharField(db_column='lValibationID', max_length=50, blank=True, null=True)  # Field name made lowercase.
    bundervalidation = models.CharField(db_column='bUnderValidation', max_length=50, blank=True, null=True)  # Field name made lowercase.
    l8did = models.CharField(db_column='l8DID', max_length=50, blank=True, null=True)  # Field name made lowercase.
    bunder8d = models.CharField(db_column='bUnder8D', max_length=50, blank=True, null=True)  # Field name made lowercase.
    lmsarnrid = models.CharField(db_column='lMSARnRID', max_length=50, blank=True, null=True)  # Field name made lowercase.
    bunderrnr = models.CharField(db_column='bUnderRnR', max_length=50, blank=True, null=True)  # Field name made lowercase.
    bunderattribute = models.CharField(db_column='bUnderAttribute', max_length=50, blank=True, null=True)  # Field name made lowercase.
    lstabilityid = models.CharField(db_column='lStabilityID', max_length=50, blank=True, null=True)  # Field name made lowercase.
    bunderstability = models.CharField(db_column='bUnderStability', max_length=50, blank=True, null=True)  # Field name made lowercase.
    lbiasid = models.CharField(db_column='lBiasID', max_length=50, blank=True, null=True)  # Field name made lowercase.
    bunderbias = models.CharField(db_column='bUnderBias', max_length=50, blank=True, null=True)  # Field name made lowercase.
    llinearityid = models.CharField(db_column='lLinearityID', max_length=50, blank=True, null=True)  # Field name made lowercase.
    bunderlinearity = models.CharField(db_column='bUnderLinearity', max_length=50, blank=True, null=True)  # Field name made lowercase.
...
class Tcheckin(models.Model):
    ...
    soriginalusername = models.CharField(db_column='sOriginalUserName', max_length=350, blank=True, null=True)  # Field name made lowercase.
...
class Adminassetcategorylist(models.Model):
    ...
    lassetid = models.BigIntegerField(db_column='lAssetID', blank=True, null=True)  # Field name made lowercase.
    btyperef = models.IntegerField(db_column='bTypeRef', blank=True, null=True)  # Field name made lowercase.
    styperefname = models.CharField(db_column='sTypeRefName', max_length=255, blank=True, null=True)  # Field name made lowercase.
    btyperefasstring = models.IntegerField(db_column='bTypeRefasString', blank=True, null=True)  # Field name made lowercase.
    btyperefasint = models.IntegerField(db_column='bTypeRefasint', blank=True, null=True)  # Field name made lowercase.
    btyperefasrange = models.IntegerField(db_column='bTypeRefasRange', blank=True, null=True)  # Field name made lowercase.
    btyperefascontinuousnoa = models.IntegerField(db_column='bTypeRefasContinuousNoA', blank=True, null=True)  # Field name made lowercase.
    btyperefascontinuousnob = models.IntegerField(db_column='bTypeRefasContinuousNoB', blank=True, null=True)  # Field name made lowercase.
    lcontinuousnoa = models.BigIntegerField(db_column='lContinuousNoA', blank=True, null=True)  # Field name made lowercase.
    lcontinuousnob = models.BigIntegerField(db_column='lContinuousNoB', blank=True, null=True)  # Field name made lowercase.
    btyperef1 = models.IntegerField(db_column='bTypeRef1', blank=True, null=True)  # Field name made lowercase.
    styperefname1 = models.CharField(db_column='sTypeRefName1', max_length=255, blank=True, null=True)  # Field name made lowercase.
    btyperefasstring1 = models.IntegerField(db_column='bTypeRefasString1', blank=True, null=True)  # Field name made lowercase.
    btyperefasint1 = models.IntegerField(db_column='bTypeRefasint1', blank=True, null=True)  # Field name made lowercase.
    btyperefasrange1 = models.IntegerField(db_column='bTypeRefasRange1', blank=True, null=True)  # Field name made lowercase.
    btyperefascontinuousnoa1 = models.IntegerField(db_column='bTypeRefasContinuousNoA1', blank=True, null=True)  # Field name made lowercase.
    btyperefascontinuousnob1 = models.IntegerField(db_column='bTypeRefasContinuousNoB1', blank=True, null=True)  # Field name made lowercase.
    lcontinuousnoa1 = models.BigIntegerField(db_column='lContinuousNoA1', blank=True, null=True)  # Field name made lowercase.
    lcontinuousnob1 = models.BigIntegerField(db_column='lContinuousNoB1', blank=True, null=True)  # Field name made lowercase.
    btyperef2 = models.IntegerField(db_column='bTypeRef2', blank=True, null=True)  # Field name made lowercase.
    styperefname2 = models.CharField(db_column='sTypeRefName2', max_length=255, blank=True, null=True)  # Field name made lowercase.
    btyperefasstring2 = models.IntegerField(db_column='bTypeRefasString2', blank=True, null=True)  # Field name made lowercase.
    btyperefasint2 = models.IntegerField(db_column='bTypeRefasint2', blank=True, null=True)  # Field name made lowercase.
    btyperefasrange2 = models.IntegerField(db_column='bTypeRefasRange2', blank=True, null=True)  # Field name made lowercase.
    btyperefascontinuousnoa2 = models.IntegerField(db_column='bTypeRefasContinuousNoA2', blank=True, null=True)  # Field name made lowercase.
    btyperefascontinuousnob2 = models.IntegerField(db_column='bTypeRefasContinuousNoB2', blank=True, null=True)  # Field name made lowercase.
    lcontinuousnoa2 = models.BigIntegerField(db_column='lContinuousNoA2', blank=True, null=True)  # Field name made lowercase.
    lcontinuousnob2 = models.BigIntegerField(db_column='lContinuousNoB2', blank=True, null=True)  # Field name made lowercase.
    btyperef3 = models.IntegerField(db_column='bTypeRef3', blank=True, null=True)  # Field name made lowercase.
    styperefname3 = models.CharField(db_column='sTypeRefName3', max_length=255, blank=True, null=True)  # Field name made lowercase.
    btyperefasstring3 = models.IntegerField(db_column='bTypeRefasString3', blank=True, null=True)  # Field name made lowercase.
    btyperefasint3 = models.IntegerField(db_column='bTypeRefasint3', blank=True, null=True)  # Field name made lowercase.
    btyperefasrange3 = models.IntegerField(db_column='bTypeRefasRange3', blank=True, null=True)  # Field name made lowercase.
    btyperefascontinuousnoa3 = models.IntegerField(db_column='bTypeRefasContinuousNoA3', blank=True, null=True)  # Field name made lowercase.
    btyperefascontinuousnob3 = models.IntegerField(db_column='bTypeRefasContinuousNoB3', blank=True, null=True)  # Field name made lowercase.
    ...
    btyperef4 = models.IntegerField(db_column='bTypeRef4', blank=True, null=True)  # Field name made lowercase.
    styperefname4 = models.CharField(db_column='sTypeRefName4', max_length=255, blank=True, null=True)  # Field name made lowercase.
    btyperefasstring4 = models.IntegerField(db_column='bTypeRefasString4', blank=True, null=True)  # Field name made lowercase.
    btyperefasint4 = models.IntegerField(db_column='bTypeRefasint4', blank=True, null=True)  # Field name made lowercase.
    btyperefasrange4 = models.IntegerField(db_column='bTypeRefasRange4', blank=True, null=True)  # Field name made lowercase.
    btyperefascontinuousnoa4 = models.IntegerField(db_column='bTypeRefasContinuousNoA4', blank=True, null=True)  # Field name made lowercase.
    btyperefascontinuousnob4 = models.IntegerField(db_column='bTypeRefasContinuousNoB4', blank=True, null=True)  # Field name made lowercase.
    ...
    btyperef5 = models.IntegerField(db_column='bTypeRef5', blank=True, null=True)  # Field name made lowercase.
    styperefname5 = models.CharField(db_column='sTypeRefName5', max_length=255, blank=True, null=True)  # Field name made lowercase.
    btyperefasstring5 = models.IntegerField(db_column='bTypeRefasString5', blank=True, null=True)  # Field name made lowercase.
    btyperefasint5 = models.IntegerField(db_column='bTypeRefasint5', blank=True, null=True)  # Field name made lowercase.
    btyperefasrange5 = models.IntegerField(db_column='bTypeRefasRange5', blank=True, null=True)  # Field name made lowercase.
    btyperefascontinuousnoa5 = models.IntegerField(db_column='bTypeRefasContinuousNoA5', blank=True, null=True)  # Field name made lowercase.
    btyperefascontinuousnob5 = models.IntegerField(db_column='bTypeRefasContinuousNoB5', blank=True, null=True)  # Field name made lowercase.
    ...
    btyperef6 = models.IntegerField(db_column='bTypeRef6', blank=True, null=True)  # Field name made lowercase.
    styperefname6 = models.CharField(db_column='sTypeRefName6', max_length=255, blank=True, null=True)  # Field name made lowercase.
    btyperefasstring6 = models.IntegerField(db_column='bTypeRefasString6', blank=True, null=True)  # Field name made lowercase.
    btyperefasint6 = models.IntegerField(db_column='bTypeRefasint6', blank=True, null=True)  # Field name made lowercase.
    btyperefasrange6 = models.IntegerField(db_column='bTypeRefasRange6', blank=True, null=True)  # Field name made lowercase.
    btyperefascontinuousnoa6 = models.IntegerField(db_column='bTypeRefasContinuousNoA6', blank=True, null=True)  # Field name made lowercase.
    btyperefascontinuousnob6 = models.IntegerField(db_column='bTypeRefasContinuousNoB6', blank=True, null=True)  # Field name made lowercase.
    ...
    btyperef7 = models.IntegerField(db_column='bTypeRef7', blank=True, null=True)  # Field name made lowercase.
    styperefname7 = models.CharField(db_column='sTypeRefName7', max_length=255, blank=True, null=True)  # Field name made lowercase.
    btyperefasstring7 = models.IntegerField(db_column='bTypeRefasString7', blank=True, null=True)  # Field name made lowercase.
    btyperefasint7 = models.IntegerField(db_column='bTypeRefasint7', blank=True, null=True)  # Field name made lowercase.
    btyperefasrange7 = models.IntegerField(db_column='bTypeRefasRange7', blank=True, null=True)  # Field name made lowercase.
    btyperefascontinuousnoa7 = models.IntegerField(db_column='bTypeRefasContinuousNoA7', blank=True, null=True)  # Field name made lowercase.
    btyperefascontinuousnob7 = models.IntegerField(db_column='bTypeRefasContinuousNoB7', blank=True, null=True)  # Field name made lowercase.
    ...
    btyperef8 = models.IntegerField(db_column='bTypeRef8', blank=True, null=True)  # Field name made lowercase.
    styperefname8 = models.CharField(db_column='sTypeRefName8', max_length=255, blank=True, null=True)  # Field name made lowercase.
    btyperefasstring8 = models.IntegerField(db_column='bTypeRefasString8', blank=True, null=True)  # Field name made lowercase.
    btyperefasint8 = models.IntegerField(db_column='bTypeRefasint8', blank=True, null=True)  # Field name made lowercase.
    btyperefasrange8 = models.IntegerField(db_column='bTypeRefasRange8', blank=True, null=True)  # Field name made lowercase.
    btyperefascontinuousnoa8 = models.IntegerField(db_column='bTypeRefasContinuousNoA8', blank=True, null=True)  # Field name made lowercase.
    btyperefascontinuousnob8 = models.IntegerField(db_column='bTypeRefasContinuousNoB8', blank=True, null=True)  # Field name made lowercase.
    ...
    btyperef9 = models.IntegerField(db_column='bTypeRef9', blank=True, null=True)  # Field name made lowercase.
    styperefname9 = models.CharField(db_column='sTypeRefName9', max_length=255, blank=True, null=True)  # Field name made lowercase.
    btyperefasstring9 = models.IntegerField(db_column='bTypeRefasString9', blank=True, null=True)  # Field name made lowercase.
    btyperefasint9 = models.IntegerField(db_column='bTypeRefasint9', blank=True, null=True)  # Field name made lowercase.
    btyperefasrange9 = models.IntegerField(db_column='bTypeRefasRange9', blank=True, null=True)  # Field name made lowercase.
    btyperefascontinuousnoa9 = models.IntegerField(db_column='bTypeRefasContinuousNoA9', blank=True, null=True)  # Field name made lowercase.
    btyperefascontinuousnob9 = models.IntegerField(db_column='bTypeRefasContinuousNoB9', blank=True, null=True)  # Field name made lowercase.
    ...
    btyperef10 = models.IntegerField(db_column='bTypeRef10', blank=True, null=True)  # Field name made lowercase.
    styperefname10 = models.CharField(db_column='sTypeRefName10', max_length=255, blank=True, null=True)  # Field name made lowercase.
    btyperefasstring10 = models.IntegerField(db_column='bTypeRefasString10', blank=True, null=True)  # Field name made lowercase.
    btyperefasint10 = models.IntegerField(db_column='bTypeRefasint10', blank=True, null=True)  # Field name made lowercase.
    btyperefasrange10 = models.IntegerField(db_column='bTypeRefasRange10', blank=True, null=True)  # Field name made lowercase.
    btyperefascontinuousnoa10 = models.IntegerField(db_column='bTypeRefasContinuousNoA10', blank=True, null=True)  # Field name made lowercase.
    btyperefascontinuousnob10 = models.IntegerField(db_column='bTypeRefasContinuousNoB10', blank=True, null=True)  # Field name made lowercase.
    ...
    btyperef11 = models.IntegerField(db_column='bTypeRef11', blank=True, null=True)  # Field name made lowercase.
    styperefname11 = models.CharField(db_column='sTypeRefName11', max_length=255, blank=True, null=True)  # Field name made lowercase.
    btyperefasstring11 = models.IntegerField(db_column='bTypeRefasString11', blank=True, null=True)  # Field name made lowercase.
    btyperefasint11 = models.IntegerField(db_column='bTypeRefasint11', blank=True, null=True)  # Field name made lowercase.
    btyperefasrange11 = models.IntegerField(db_column='bTypeRefasRange11', blank=True, null=True)  # Field name made lowercase.
    btyperefascontinuousnoa11 = models.IntegerField(db_column='bTypeRefasContinuousNoA11', blank=True, null=True)  # Field name made lowercase.
    btyperefascontinuousnob11 = models.IntegerField(db_column='bTypeRefasContinuousNoB11', blank=True, null=True)  # Field name made lowercase.
    ...
    btyperef12 = models.IntegerField(db_column='bTypeRef12', blank=True, null=True)  # Field name made lowercase.
    styperefname12 = models.CharField(db_column='sTypeRefName12', max_length=255, blank=True, null=True)  # Field name made lowercase.
    btyperefasstring12 = models.IntegerField(db_column='bTypeRefasString12', blank=True, null=True)  # Field name made lowercase.
    btyperefasint12 = models.IntegerField(db_column='bTypeRefasint12', blank=True, null=True)  # Field name made lowercase.
    btyperefasrange12 = models.IntegerField(db_column='bTypeRefasRange12', blank=True, null=True)  # Field name made lowercase.
    btyperefascontinuousnoa12 = models.IntegerField(db_column='bTypeRefasContinuousNoA12', blank=True, null=True)  # Field name made lowercase.
    btyperefascontinuousnob12 = models.IntegerField(db_column='bTypeRefasContinuousNoB12', blank=True, null=True)  # Field name made lowercase.
    ...
    btyperef13 = models.IntegerField(db_column='bTypeRef13', blank=True, null=True)  # Field name made lowercase.
    styperefname13 = models.CharField(db_column='sTypeRefName13', max_length=255, blank=True, null=True)  # Field name made lowercase.
    btyperefasstring13 = models.IntegerField(db_column='bTypeRefasString13', blank=True, null=True)  # Field name made lowercase.
    btyperefasint13 = models.IntegerField(db_column='bTypeRefasint13', blank=True, null=True)  # Field name made lowercase.
    btyperefasrange13 = models.IntegerField(db_column='bTypeRefasRange13', blank=True, null=True)  # Field name made lowercase.
    btyperefascontinuousnoa13 = models.IntegerField(db_column='bTypeRefasContinuousNoA13', blank=True, null=True)  # Field name made lowercase.
    btyperefascontinuousnob13 = models.IntegerField(db_column='bTypeRefasContinuousNoB13', blank=True, null=True)  # Field name made lowercase.
    ...
    btyperef14 = models.IntegerField(db_column='bTypeRef14', blank=True, null=True)  # Field name made lowercase.
    styperefname14 = models.CharField(db_column='sTypeRefName14', max_length=255, blank=True, null=True)  # Field name made lowercase.
    btyperefasstring14 = models.IntegerField(db_column='bTypeRefasString14', blank=True, null=True)  # Field name made lowercase.
    btyperefasint14 = models.IntegerField(db_column='bTypeRefasint14', blank=True, null=True)  # Field name made lowercase.
    btyperefasrange14 = models.IntegerField(db_column='bTypeRefasRange14', blank=True, null=True)  # Field name made lowercase.
    btyperefascontinuousnoa14 = models.IntegerField(db_column='bTypeRefasContinuousNoA14', blank=True, null=True)  # Field name made lowercase.
    btyperefascontinuousnob14 = models.IntegerField(db_column='bTypeRefasContinuousNoB14', blank=True, null=True)  # Field name made lowercase.
    ...
    btyperef15 = models.IntegerField(db_column='bTypeRef15', blank=True, null=True)  # Field name made lowercase.
    styperefname15 = models.CharField(db_column='sTypeRefName15', max_length=255, blank=True, null=True)  # Field name made lowercase.
    btyperefasstring15 = models.IntegerField(db_column='bTypeRefasString15', blank=True, null=True)  # Field name made lowercase.
    btyperefasint15 = models.IntegerField(db_column='bTypeRefasint15', blank=True, null=True)  # Field name made lowercase.
    btyperefasrange15 = models.IntegerField(db_column='bTypeRefasRange15', blank=True, null=True)  # Field name made lowercase.
    btyperefascontinuousnoa15 = models.IntegerField(db_column='bTypeRefasContinuousNoA15', blank=True, null=True)  # Field name made lowercase.
    btyperefascontinuousnob15 = models.IntegerField(db_column='bTypeRefasContinuousNoB15', blank=True, null=True)  # Field name made lowercase.
    ...
    btyperef16 = models.IntegerField(db_column='bTypeRef16', blank=True, null=True)  # Field name made lowercase.
    styperefname16 = models.CharField(db_column='sTypeRefName16', max_length=255, blank=True, null=True)  # Field name made lowercase.
    btyperefasstring16 = models.IntegerField(db_column='bTypeRefasString16', blank=True, null=True)  # Field name made lowercase.
    btyperefasint16 = models.IntegerField(db_column='bTypeRefasint16', blank=True, null=True)  # Field name made lowercase.
    btyperefasrange16 = models.IntegerField(db_column='bTypeRefasRange16', blank=True, null=True)  # Field name made lowercase.
    btyperefascontinuousnoa16 = models.IntegerField(db_column='bTypeRefasContinuousNoA16', blank=True, null=True)  # Field name made lowercase.
    btyperefascontinuousnob16 = models.IntegerField(db_column='bTypeRefasContinuousNoB16', blank=True, null=True)  # Field name made lowercase.
    ...
    btyperef17 = models.IntegerField(db_column='bTypeRef17', blank=True, null=True)  # Field name made lowercase.
    styperefname17 = models.CharField(db_column='sTypeRefName17', max_length=255, blank=True, null=True)  # Field name made lowercase.
    btyperefasstring17 = models.IntegerField(db_column='bTypeRefasString17', blank=True, null=True)  # Field name made lowercase.
    btyperefasint17 = models.IntegerField(db_column='bTypeRefasint17', blank=True, null=True)  # Field name made lowercase.
    btyperefasrange17 = models.IntegerField(db_column='bTypeRefasRange17', blank=True, null=True)  # Field name made lowercase.
    btyperefascontinuousnoa17 = models.IntegerField(db_column='bTypeRefasContinuousNoA17', blank=True, null=True)  # Field name made lowercase.
    btyperefascontinuousnob17 = models.IntegerField(db_column='bTypeRefasContinuousNoB17', blank=True, null=True)  # Field name made lowercase.
    ...
    btyperef18 = models.IntegerField(db_column='bTypeRef18', blank=True, null=True)  # Field name made lowercase.
    styperefname18 = models.CharField(db_column='sTypeRefName18', max_length=255, blank=True, null=True)  # Field name made lowercase.
    btyperefasstring18 = models.IntegerField(db_column='bTypeRefasString18', blank=True, null=True)  # Field name made lowercase.
    btyperefasint18 = models.IntegerField(db_column='bTypeRefasint18', blank=True, null=True)  # Field name made lowercase.
    btyperefasrange18 = models.IntegerField(db_column='bTypeRefasRange18', blank=True, null=True)  # Field name made lowercase.
    btyperefascontinuousnoa18 = models.IntegerField(db_column='bTypeRefasContinuousNoA18', blank=True, null=True)  # Field name made lowercase.
    btyperefascontinuousnob18 = models.IntegerField(db_column='bTypeRefasContinuousNoB18', blank=True, null=True)  # Field name made lowercase.
    ...
    btyperef19 = models.IntegerField(db_column='bTypeRef19', blank=True, null=True)  # Field name made lowercase.
    styperefname19 = models.CharField(db_column='sTypeRefName19', max_length=255, blank=True, null=True)  # Field name made lowercase.
    btyperefasstring19 = models.IntegerField(db_column='bTypeRefasString19', blank=True, null=True)  # Field name made lowercase.
    btyperefasint19 = models.IntegerField(db_column='bTypeRefasint19', blank=True, null=True)  # Field name made lowercase.
    btyperefasrange19 = models.IntegerField(db_column='bTypeRefasRange19', blank=True, null=True)  # Field name made lowercase.
    btyperefascontinuousnoa19 = models.IntegerField(db_column='bTypeRefasContinuousNoA19', blank=True, null=True)  # Field name made lowercase.
    btyperefascontinuousnob19 = models.IntegerField(db_column='bTypeRefasContinuousNoB19', blank=True, null=True)  # Field name made lowercase.
    ...
    btyperef20 = models.IntegerField(db_column='bTypeRef20', blank=True, null=True)  # Field name made lowercase.
    styperefname20 = models.CharField(db_column='sTypeRefName20', max_length=255, blank=True, null=True)  # Field name made lowercase.
    btyperefasstring20 = models.IntegerField(db_column='bTypeRefasString20', blank=True, null=True)  # Field name made lowercase.
    btyperefasint20 = models.IntegerField(db_column='bTypeRefasint20', blank=True, null=True)  # Field name made lowercase.
    btyperefasrange20 = models.IntegerField(db_column='bTypeRefasRange20', blank=True, null=True)  # Field name made lowercase.
    btyperefascontinuousnoa20 = models.IntegerField(db_column='bTypeRefasContinuousNoA20', blank=True, null=True)  # Field name made lowercase.
    btyperefascontinuousnob20 = models.IntegerField(db_column='bTypeRefasContinuousNoB20', blank=True, null=True)  # Field name made lowercase.
    ...
    bpartno = models.IntegerField(db_column='bPartNo', blank=True, null=True)  # Field name made lowercase.
    bequipment = models.IntegerField(db_column='bEquipment', blank=True, null=True)  # Field name made lowercase.
    bmachine = models.IntegerField(db_column='bMachine', blank=True, null=True)  # Field name made lowercase.
    brange2variable = models.IntegerField(db_column='bRange2Variable', blank=True, null=True)  # Field name made lowercase.
    brange3variable = models.IntegerField(db_column='bRange3Variable', blank=True, null=True)  # Field name made lowercase.
    bmaterial = models.IntegerField(db_column='bMaterial', blank=True, null=True)  # Field name made lowercase.
    boperation = models.IntegerField(db_column='bOperation', blank=True, null=True)  # Field name made lowercase.
    bcontinuousno = models.IntegerField(db_column='bContinuousNo', blank=True, null=True)  # Field name made lowercase.
    btype = models.IntegerField(db_column='bType', blank=True, null=True)  # Field name made lowercase.
    btype1 = models.IntegerField(db_column='bType1', blank=True, null=True)  # Field name made lowercase.
    btype2 = models.IntegerField(db_column='bType2', blank=True, null=True)  # Field name made lowercase.
    btype3 = models.IntegerField(db_column='bType3', blank=True, null=True)  # Field name made lowercase.
    btype4 = models.IntegerField(db_column='bType4', blank=True, null=True)  # Field name made lowercase.
    btype5 = models.IntegerField(db_column='bType5', blank=True, null=True)  # Field name made lowercase.
    btype6 = models.IntegerField(db_column='bType6', blank=True, null=True)  # Field name made lowercase.
...
class Adminassetcategorytypelist1A(models.Model):
    lcategorytypeid = models.CharField(db_column='lCategoryTypeID', max_length=50, blank=True, null=True)  # Field name made lowercase.
    scategorytype = models.CharField(db_column='sCategoryType', max_length=50, blank=True, null=True)  # Field name made lowercase.
    lcategorytype1 = models.CharField(db_column='lCategoryType1', max_length=50, blank=True, null=True)  # Field name made lowercase.
    lcategorytype2 = models.CharField(db_column='lCategoryType2', max_length=50, blank=True, null=True)  # Field name made lowercase.
    scode = models.CharField(db_column='sCode', max_length=50, blank=True, null=True)  # Field name made lowercase.
    lcode1 = models.CharField(db_column='lCode1', max_length=50, blank=True, null=True)  # Field name made lowercase.
    lcode2 = models.CharField(db_column='lCode2', max_length=50, blank=True, null=True)  # Field name made lowercase.
    styperefname = models.CharField(db_column='sTypeRefName', max_length=50, blank=True, null=True)  # Field name made lowercase.
    btyperefasstring = models.CharField(db_column='bTypeRefasString', max_length=50, blank=True, null=True)  # Field name made lowercase.
    btyperefasint = models.CharField(db_column='bTypeRefasint', max_length=50, blank=True, null=True)  # Field name made lowercase.
    btyperefasrange = models.CharField(db_column='bTypeRefasRange', max_length=50, blank=True, null=True)  # Field name made lowercase.
    btyperefascontinuousnoa = models.CharField(db_column='bTypeRefasContinuousNoA', max_length=50, blank=True, null=True)  # Field name made lowercase.
    btyperefascontinuousnob = models.CharField(db_column='bTypeRefasContinuousNoB', max_length=50, blank=True, null=True)  # Field name made lowercase.
    lcontinuousnoa = models.CharField(db_column='lContinuousNoA', max_length=50, blank=True, null=True)  # Field name made lowercase.
    lcontinuousnob = models.CharField(db_column='lContinuousNoB', max_length=50, blank=True, null=True)  # Field name made lowercase.
    lplantid = models.CharField(db_column='lPlantId', max_length=50, blank=True, null=True)  # Field name made lowercase.
    splantname = models.CharField(db_column='sPlantName', max_length=50, blank=True, null=True)  # Field name made lowercase.
    lcompanyid = models.CharField(db_column='lCompanyId', max_length=50, blank=True, null=True)  # Field name made lowercase.
    scompantname = models.CharField(db_column='sCompantName', max_length=50, blank=True, null=True)  # Field name made lowercase.
    bpartno = models.CharField(db_column='bPartNo', max_length=50, blank=True, null=True)  # Field name made lowercase.
    bequipment = models.CharField(db_column='bEquipment', max_length=50, blank=True, null=True)  # Field name made lowercase.
    bmachine = models.CharField(db_column='bMachine', max_length=50, blank=True, null=True)  # Field name made lowercase.
    brange2variable = models.CharField(db_column='bRange2Variable', max_length=50, blank=True, null=True)  # Field name made lowercase.
    brange3variable = models.CharField(db_column='bRange3Variable', max_length=50, blank=True, null=True)  # Field name made lowercase.
    bmaterial = models.CharField(db_column='bMaterial', max_length=50, blank=True, null=True)  # Field name made lowercase.
    boperation = models.CharField(db_column='bOperation', max_length=50, blank=True, null=True)  # Field name made lowercase.
    bcontinuousno = models.CharField(db_column='bContinuousNo', max_length=50, blank=True, null=True)  # Field name made lowercase.
    btype = models.CharField(db_column='bType', max_length=50, blank=True, null=True)  # Field name made lowercase.
    btype1 = models.CharField(db_column='bType1', max_length=50, blank=True, null=True)  # Field name made lowercase.
    btype2 = models.CharField(db_column='bType2', max_length=50, blank=True, null=True)  # Field name made lowercase.
    btype3 = models.CharField(db_column='bType3', max_length=50, blank=True, null=True)  # Field name made lowercase.
    btype4 = models.CharField(db_column='bType4', max_length=50, blank=True, null=True)  # Field name made lowercase.
    btype5 = models.CharField(db_column='bType5', max_length=50, blank=True, null=True)  # Field name made lowercase.
    btype6 = models.CharField(db_column='bType6', max_length=50, blank=True, null=True)  # Field name made lowercase.
    lcode = models.CharField(db_column='lCode', max_length=50, blank=True, null=True)  # Field name made lowercase.
    lcode3 = models.CharField(db_column='lCode3', max_length=50, blank=True, null=True)  # Field name made lowercase.
    lcode4 = models.CharField(db_column='lCode4', max_length=50, blank=True, null=True)  # Field name made lowercase.
    lcode5 = models.CharField(db_column='lCode5', max_length=50, blank=True, null=True)  # Field name made lowercase.
    stitle = models.CharField(db_column='sTitle', max_length=50, blank=True, null=True)  # Field name made lowercase.
    stitle1 = models.CharField(db_column='sTitle1', max_length=50, blank=True, null=True)  # Field name made lowercase.
    stitle2 = models.CharField(db_column='sTitle2', max_length=50, blank=True, null=True)  # Field name made lowercase.
    stitle3 = models.CharField(db_column='sTitle3', max_length=50, blank=True, null=True)  # Field name made lowercase.
    stitle4 = models.CharField(db_column='sTitle4', max_length=50, blank=True, null=True)  # Field name made lowercase.
    stitle5 = models.CharField(db_column='sTitle5', max_length=50, blank=True, null=True)  # Field name made lowercase.
...
class Adminassetserialformatlist(models.Model):
    ...
    lcompanyid = models.BigIntegerField(db_column='lCompanyID', blank=True, null=True)  # Field name made lowercase.
    lserialno1 = models.BigIntegerField(db_column='lSerialNo1', blank=True, null=True)  # Field name made lowercase.
...
class Adminassetserialformatlistb(models.Model):
    lid = models.CharField(db_column='lId', max_length=50, blank=True, null=True)  # Field name made lowercase.
    scode = models.CharField(db_column='sCode', max_length=50, blank=True, null=True)  # Field name made lowercase.
    lserialno = models.CharField(db_column='lSerialNo', max_length=50, blank=True, null=True)  # Field name made lowercase.
    lcompanyid = models.CharField(db_column='lCompanyID', max_length=50, blank=True, null=True)  # Field name made lowercase.
    lserialno1 = models.CharField(db_column='lSerialNo1', max_length=50, blank=True, null=True)  # Field name made lowercase.
...
class Adminexternalagencylist(models.Model):
    ...
    lcompanyid = models.BigIntegerField(db_column='lCompanyId', blank=True, null=True)  # Field name made lowercase.
    scompantname = models.CharField(db_column='sCompantName', max_length=650, blank=True, null=True)  # Field name made lowercase.
    bproductionvendor = models.IntegerField(db_column='bProductionVendor', blank=True, null=True)  # Field name made lowercase.
