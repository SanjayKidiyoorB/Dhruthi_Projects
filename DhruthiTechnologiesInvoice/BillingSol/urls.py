...
urlpatterns = [
    ...
    path("OrderAcceptanceMaintenanceListDetailsCopyCreate/<int:lID>", viewstransaction.OrderAcceptanceMaintenanceListDetailsCopyCreate, name="OrderAcceptanceMaintenanceListDetailsCopyCreate"),

    path("OrderAcceptanceProjectListDetailsCopyCreate/<int:lID>", viewstransaction.OrderAcceptanceProjectListDetailsCopyCreate, name="OrderAcceptanceProjectListDetailsCopyCreate"),

    path("OrderAcceptanceProformaListDetailsCopyCreate/<int:lID>", viewstransaction.OrderAcceptanceProformaListDetailsCopyCreate, name="OrderAcceptanceProformaListDetailsCopyCreate"),

    path("OrderAcceptanceDCListDetailsCopyCreate/<int:lID>", viewstransaction.OrderAcceptanceDCListDetailsCopyCreate, name="OrderAcceptanceDCListDetailsCopyCreate"),
