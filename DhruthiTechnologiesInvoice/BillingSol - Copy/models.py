...
class Tcreditnotelist(models.Model):
    ...
    sworkfrom1 = models.CharField(db_column='sWorkFrom1', max_length=50, blank=True, null=True)  # Field name made lowercase.
    sworkfto1 = models.CharField(db_column='sWorkFTo1', max_length=50, blank=True, null=True)  # Field name made lowercase.
...
class Tpurchaseorderlist(models.Model):
    ...
    lnoofedit = models.IntegerField(db_column='lNoofEdit', blank=True, null=True)  # Field name made lowercase.
    ddateofedit = models.CharField(db_column='dDateofEdit', max_length=20, blank=True, null=True)  # Field name made lowercase.
    deliveryto = models.CharField(db_column='DeliveryTo', max_length=100, blank=True, null=True)  # Field name made lowercase.
    skindattn = models.CharField(db_column='sKindAttn', max_length=100, blank=True, null=True)  # Field name made lowercase.
    ...
    sterm1 = models.CharField(db_column='sTerm1', max_length=100, blank=True, null=True)  # Field name made lowercase.
    sterm2 = models.CharField(db_column='sTerm2', max_length=100, blank=True, null=True)  # Field name made lowercase.
    sterm3 = models.CharField(db_column='sTerm3', max_length=100, blank=True, null=True)  # Field name made lowercase.
    sterm4 = models.CharField(db_column='sTerm4', max_length=100, blank=True, null=True)  # Field name made lowercase.
    sterm5 = models.CharField(db_column='sTerm5', max_length=100, blank=True, null=True)  # Field name made lowercase.
    sterm6 = models.CharField(db_column='sTerm6', max_length=100, blank=True, null=True)  # Field name made lowercase.
    sterm7 = models.CharField(db_column='sTerm7', max_length=100, blank=True, null=True)  # Field name made lowercase.
    sterm8 = models.CharField(db_column='sTerm8', max_length=100, blank=True, null=True)  # Field name made lowercase.
    sterm9 = models.CharField(db_column='sTerm9', max_length=100, blank=True, null=True)  # Field name made lowercase.
    sterm10 = models.CharField(db_column='sTerm10', max_length=100, blank=True, null=True)  # Field name made lowercase.
    bdelete = models.BooleanField(db_column='bDelete', blank=True, null=True)  # Field name made lowercase.
    bcancelcopy = models.BooleanField(db_column='bCancelCopy', blank=True, null=True)  # Field name made lowercase.
    bapproval0 = models.BooleanField(db_column='bApproval0', blank=True, null=True)  # Field name made lowercase.
    bapproval01 = models.BooleanField(db_column='bApproval01', blank=True, null=True)  # Field name made lowercase.
    ...
    ssitename = models.CharField(db_column='sSiteName', max_length=100, blank=True, null=True)  # Field name made lowercase.
    dsgst01 = models.FloatField(db_column='dSGST01', blank=True, null=True)  # Field name made lowercase.
    dcgst01 = models.FloatField(db_column='dCGST01', blank=True, null=True)  # Field name made lowercase.
    dcgst00 = models.FloatField(db_column='dCGST00', blank=True, null=True)  # Field name made lowercase.
    dsgst5 = models.FloatField(db_column='dSGST5', blank=True, null=True)  # Field name made lowercase.
    ...
    dcgst1pt0 = models.FloatField(db_column='dCGST1pt0', blank=True, null=True)  # Field name made lowercase.
    dcgst1pt00 = models.FloatField(db_column='dCGST1pt00', blank=True, null=True)  # Field name made lowercase.
    sterm11 = models.CharField(db_column='sTerm11', max_length=100, blank=True, null=True)  # Field name made lowercase.
    sterm12 = models.CharField(db_column='sTerm12', max_length=100, blank=True, null=True)  # Field name made lowercase.
    sterm13 = models.CharField(db_column='sTerm13', max_length=100, blank=True, null=True)  # Field name made lowercase.
    sterm14 = models.CharField(db_column='sTerm14', max_length=100, blank=True, null=True)  # Field name made lowercase.
    sterm15 = models.CharField(db_column='sTerm15', max_length=100, blank=True, null=True)  # Field name made lowercase.
    sdate = models.CharField(db_column='sDate', max_length=50, blank=True, null=True)  # Field name made lowercase.
    sdate1 = models.CharField(db_column='sDate1', max_length=50, blank=True, null=True)  # Field name made lowercase.
    llocationid = models.IntegerField(db_column='lLocationId', blank=True, null=True)  # Field name made lowercase.
    slocation = models.CharField(db_column='sLocation', max_length=200, blank=True, null=True)  # Field name made lowercase.
